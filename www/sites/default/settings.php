 ...
 * @endcode
 */
$settings['hash_salt'] = 'KDCHQgQ2WeQs_FceyNTUADdA1Gi5Yr5UAtXraLpY0lUnxgQFZCb7DN3PPYOoJLOf4HkvdL04Fg';
...
if (file_exists($app_root . '/' . $site_path . '/settings.master.php')) {
  include $app_root . '/' . $site_path . '/settings.master.php';
}
...
$settings['trusted_host_patterns'] = [
  '^vin\.auction$',               // mydomain.com
  '^(www\.)?vin\.auction$',       // mydomain.com AND www.mydomain.com
  '^(.+?\.)?vin\.auction$',       // mydomain.com AND ANY subdomain (ex: foobar.mydomain.com)
  '^vinauction\.docksal',
  '^.+\.vinauction\.docksal',
  '^develop\.vin\.auction',
  '^vinauction\.webhosting\.be',
  '^test\.vin\.auction',
];
